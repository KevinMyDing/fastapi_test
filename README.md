...
[![codecov](https://codecov.io/gh/KevinMyDing/fastapi_test/branch/main/graph/badge.svg?token=fastapi_test_token_here)](https://codecov.io/gh/KevinMyDing/fastapi_test)
[![CI](https://github.com/KevinMyDing/fastapi_test/actions/workflows/main.yml/badge.svg)](https://github.com/KevinMyDing/fastapi_test/actions/workflows/main.yml)

Awesome fastapi_test created by KevinMyDing

## Install

from source
```bash
git clone https://github.com/KevinMyDing/fastapi_test fastapi_test
cd fastapi_test
make install
```
